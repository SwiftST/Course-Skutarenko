...
// Есл ивы передаете свойство имеющее наблюдателей, в функцию в качестве сквозного параметра, то наблюдатели willSet и didSet всегда вызываюстя. Это происходит из за модели копирования copy-in copy-out для сквозных параметров: значение всегда записывается обратно в свойство в конце функции
