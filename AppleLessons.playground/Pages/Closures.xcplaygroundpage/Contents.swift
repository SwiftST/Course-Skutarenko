...
// Замыкания - это автономные функциональные блоки, которые можно передавать и использовать в коде.
...
// 3. Вариатиыне параметры могут быть использованы, если дать им имя
...
struct SomeStruct {
    ...
    mutating func doSomething() {
        //someFunctionWithEscapingClosure { x = 100 } //Ошибка
        someFunctionWithNonescapingClosure { x = 200 }
    }
}

// В структурах сбегающие замыкания не могут захватывать изменяемую ссылку на self
